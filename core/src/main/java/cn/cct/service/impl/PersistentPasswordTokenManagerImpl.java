...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see cn.cct.service.impl.PasswordTokenManager#generateRecoveryToken(cn.cct.model.User)
     */
    @Override
    ...
    /**
     * @see cn.cct.service.impl.PasswordTokenManager#isRecoveryTokenValid(cn.cct.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see cn.cct.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
